...
public class JavaHashMap {
    public static void main(String[] args) {
        ...
        System.out.println("m.get(2) = " + m.get(2));//2 anahtarındaki değerler alındı m.get(2) = 14
        System.out.println("m.keySet() = " + m.keySet());//anahtar listesi [2, 3, 4]
        System.out.println("m.values() = " + m.values());//değerler listesi [14, 12, 13]
