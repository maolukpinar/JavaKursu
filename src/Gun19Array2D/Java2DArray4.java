...
public class Java2DArray4 {
    public static void main(String[] args) {
        ...
        int[] dizi1 = new int [5];//bir boyutlu dizi tanımlaması
        int[] dizi2 = {4,7,18,13};//bir boyutlu dizi tanımlaması hem tanımlama hem değer atama

        int [] [] mat1=new int [2] [3];//2 boyutlu dizi tanımlaması
        int [] [] mat2={ {65, 76, 90},{80, 66, 95} };//2 boyutlu dizi hem tanımlama hem değer atama
