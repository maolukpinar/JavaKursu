package Gun32ClasOrnek.Example.Ex1;

public class Ex1 {
    //1.Adım :Person isimli bir class yazınız:fields: name, surname, age; olsun
    //2.Adım :main de 2 tane bu sınıftran nesne oluştutup değer atayınız.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("kisi2 nin doğum yılı = " + kisi2.getBirthYear());
